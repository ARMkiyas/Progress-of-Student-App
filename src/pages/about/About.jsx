...
import AmithaFonseka from './images/AmithaFonseka.jpg'
import DilkiHasani from './images/DilkiHasani.jpg'
import ErickSandaruwan from './images/ErickSandaruwan.jpg'
import LasaniSubodhani from './images/LasaniSubodhani.jpg'
import MohammedKiyas from './images/MohammedKiyas.jpg'
import ParamananthamDokitha from './images/ParamananthamDokitha.jpg'
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="pr-3 mb-5 about-item mb-lg-0">
                ...
                <Link
                  to="/generate"
                  className="text-black no-underline btn-get-started animate__animated animate__fadeInUp scrollto dark:text-red-700"
                >    Get Started</Link>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-item-img">
                <img loading="lazy" src={aboutus} width="800" height="300" alt="about-image" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pt-0 about-info section">
        <div className="container">
          <div className="row justify-content-center">
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="mb-4 about-info-item mb-lg-0">
                <h3 className="mb-3"><span className="mr-2 text-4xl text-color">02.</span>Our Vision</h3>
        ...
        <div className="max-w-screen-xl px-4 pt-0 mx-auto text-center lg:py-16 lg:px-6">
          ...
          <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 ">
            ...
            <div className="text-center text-gray-500 dark:text-gray-400">
              <img className="mx-auto mb-4 rounded-full w-36 h-36" src=  {MohammedKiyas} alt="Mohammed Kiyas" />
            ...
            <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src={AmithaFonseka} alt="Amitha Fonseka" />
            ...
            <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src= {ParamananthamDokitha} alt="Paramanantham Dokitha" />
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                Paramanantham Dokitha
              </h3>
              ...
              <ul class="flex justify-center mt-4 space-x-4 p-0">
                ...
                <li>
                  <a href="https://www.linkedin.com/in/dokitha-paramanantham-544a63295" class="text-blue-600 hover:text-gray-900 dark:hover:text-white dark:text-blue-500">
            ...
            <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src={LasaniSubodhani} alt="Lasani Subodhani" />
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                Lasani Subodanee
              </h3>
              ...
              <ul class="flex justify-center mt-4 space-x-4 p-0">
                ...
                <li>
                  <a href="https://github.com/Lasani12Subodanee" class="text-[#00acee] hover:text-gray-900 dark:hover:text-white">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"> <path fill-rule="evenodd" d="M10 .333A9.911 9.911 0 0 0 6.866 19.65c.5.092.678-.215.678-.477 0-.237-.01-1.017-.014-1.845-2.757.6-3.338-1.169-3.338-1.169a2.627 2.627 0 0 0-1.1-1.451c-.9-.615.07-.6.07-.6a2.084 2.084 0 0 1 1.518 1.021 2.11 2.11 0 0 0 2.884.823c.044-.503.268-.973.63-1.325-2.2-.25-4.516-1.1-4.516-4.9A3.832 3.832 0 0 1 4.7 7.068a3.56 3.56 0 0 1 .095-2.623s.832-.266 2.726 1.016a9.409 9.409 0 0 1 4.962 0c1.89-1.282 2.717-1.016 2.717-1.016.366.83.402 1.768.1 2.623a3.827 3.827 0 0 1 1.02 2.659c0 3.807-2.319 4.644-4.525 4.889a2.366 2.366 0 0 1 .673 1.834c0 1.326-.012 2.394-.012 2.72 0 .263.18.572.681.475A9.911 9.911 0 0 0 10 .333Z" clip-rule="evenodd" /></svg>
                  </a>
                </li>
                <li>
            ...
            <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src={DilkiHasani} alt="Dilki Hasani" />
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                Dilki Hasani
              </h3>
              ...
              <ul class="flex justify-center mt-4 space-x-4 p-0">
                ...
                <li>
                  <a href="https://github.com/Dilki-Dissanayake" class="text-[#00acee] hover:text-gray-900 dark:hover:text-white">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"> <path fill-rule="evenodd" d="M10 .333A9.911 9.911 0 0 0 6.866 19.65c.5.092.678-.215.678-.477 0-.237-.01-1.017-.014-1.845-2.757.6-3.338-1.169-3.338-1.169a2.627 2.627 0 0 0-1.1-1.451c-.9-.615.07-.6.07-.6a2.084 2.084 0 0 1 1.518 1.021 2.11 2.11 0 0 0 2.884.823c.044-.503.268-.973.63-1.325-2.2-.25-4.516-1.1-4.516-4.9A3.832 3.832 0 0 1 4.7 7.068a3.56 3.56 0 0 1 .095-2.623s.832-.266 2.726 1.016a9.409 9.409 0 0 1 4.962 0c1.89-1.282 2.717-1.016 2.717-1.016.366.83.402 1.768.1 2.623a3.827 3.827 0 0 1 1.02 2.659c0 3.807-2.319 4.644-4.525 4.889a2.366 2.366 0 0 1 .673 1.834c0 1.326-.012 2.394-.012 2.72 0 .263.18.572.681.475A9.911 9.911 0 0 0 10 .333Z" clip-rule="evenodd" /></svg>
                  </a>
                </li>
                <li>
            ...
            <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src={ErickSandaruwan} alt="Erick Sandaruwan" />
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                Erick Sandaruwan
              </h3>
              ...
              <ul class="flex justify-center mt-4 space-x-4 p-0">
                ...
                <li>
                  <a href="https://github.com/erickkothalawala" class="text-[#00acee] hover:text-gray-900 dark:hover:text-white">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"> <path fill-rule="evenodd" d="M10 .333A9.911 9.911 0 0 0 6.866 19.65c.5.092.678-.215.678-.477 0-.237-.01-1.017-.014-1.845-2.757.6-3.338-1.169-3.338-1.169a2.627 2.627 0 0 0-1.1-1.451c-.9-.615.07-.6.07-.6a2.084 2.084 0 0 1 1.518 1.021 2.11 2.11 0 0 0 2.884.823c.044-.503.268-.973.63-1.325-2.2-.25-4.516-1.1-4.516-4.9A3.832 3.832 0 0 1 4.7 7.068a3.56 3.56 0 0 1 .095-2.623s.832-.266 2.726 1.016a9.409 9.409 0 0 1 4.962 0c1.89-1.282 2.717-1.016 2.717-1.016.366.83.402 1.768.1 2.623a3.827 3.827 0 0 1 1.02 2.659c0 3.807-2.319 4.644-4.525 4.889a2.366 2.366 0 0 1 .673 1.834c0 1.326-.012 2.394-.012 2.72 0 .263.18.572.681.475A9.911 9.911 0 0 0 10 .333Z" clip-rule="evenodd" /></svg>
                  </a>
                </li>
                <li>
                  <a href="https://www.linkedin.com/in/erick-sandaruwan-kothalawala-8a260229a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" class="text-blue-600 hover:text-gray-900 dark:hover:text-white dark:text-blue-500">
