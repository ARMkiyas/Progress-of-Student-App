...
export default function Nav() {
  ...
  return (
    <header className={loc.pathname !== "/" ? "relative w-full h-20" : ""}>
      <nav className="absolute z-20 w-full shadow-2xl h-fit backdrop-blur cusnavbar shadow-gray-600/5 peer-checked:navbar-active dark:shadow-none ">
        <div className="px-6 m-auto xl:container md:px-12 lg:px-6 ">
          <div className="flex flex-wrap items-center justify-between gap-6 md:py-3 md:gap-0 lg:py-5">
            <div className="flex items-center justify-between w-full lg:w-auto">
              <Link
                className="relative z-10 no-underline text "
                to="/"
                aria-label="logo"
              >
              ...
              <label
                htmlFor="hbr"
                className="relative z-20 block p-6 -mr-6 cursor-pointer peer-checked:hamburger lg:hidden"
              >
                <div
                  aria-hidden="true"
            ...
            <div className="flex-wrap items-center justify-end hidden w-full p-6 mb-16 space-y-8 shadow-2xl navmenu rounded-3xl shadow-gray-300/20 lg:space-y-0 lg:p-0 lg:m-0 lg:flex md:flex-nowrap lg:bg-transparent lg:w-7/12 lg:shadow-none dark:shadow-none">
              <div className="cusnavitem">
                <ul className="space-y-6 text-base font-medium tracking-wide lg:text-sm lg:flex lg:space-y-0">
                  <li>
                    <Link
                      to="/"
